...
<link href="<?=SITE_TEMPLATE_PATH?>/colors.css" type="text/css" rel="stylesheet" />
    ...
    <?
    Asset::getInstance()->addCss(SITE_TEMPLATE_PATH . '/dist/css/style.css');
    Asset::getInstance()->addJs(SITE_TEMPLATE_PATH . '/dist/js/libs/jquery3.6.1.js');
    Asset::getInstance()->addJs(SITE_TEMPLATE_PATH . '/dist/js/libs/parsley.min.js');
    Asset::getInstance()->addJs(SITE_TEMPLATE_PATH . '/dist/js/script.js');
    ?>
